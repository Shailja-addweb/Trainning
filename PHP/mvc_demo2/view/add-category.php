			...
			<td><?php 
			 	if (!empty($row['id'])) { 
			 		?><div class="forImages"><?php 
						...
						<a id="remove" data-id=<?php echo $row['id'];?> href="javascript:;">REMOVE PHOTO</a>
					</div><br>
					...
					?><input type="file" name="image" accept="image/*" id="newimage"  value="<?php if(!empty($row['image'])) echo $row['image']; else echo '';?>"><?php 
				} 
			?></td>
		</tr><?php 
			if(!empty($row['id'])) {
